...
function HackerrankIcon() {
  return (
    <svg
      ...
      className={iconClasses}
    >
      <polygon points="32 2 8 16 8 48 32 62 56 48 56 16 32 2" fill="#00EA64" />
      <rect x="24" y="18" width="6" height="28" fill="#000000" />
      <rect x="34" y="18" width="6" height="28" fill="#000000" />
    </svg>
  );
}
...
const defaultLinks: SocialLink[] = [
  ...
  {
    id: "hackerrank",
    href: "https://www.hackerrank.com/vishnuvt1183",
